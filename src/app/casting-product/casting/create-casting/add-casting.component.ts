...
@Component({
    selector     : 'add-casting',
    templateUrl  : './add-casting.component.html',
    styleUrls    : ['./add-casting.component.scss'],
    animations   : fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class AddCastingComponent implements OnInit, OnDestroy, OnChanges {
    ...
    constructor(
        public dialogRef: MatDialogRef<AddCastingComponent>,
